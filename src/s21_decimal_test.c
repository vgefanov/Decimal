...
test_struct_ddd test_pack_add[] = {
    ...
    {{0x8141ab54, 0x00000000, 0x00000000, 0x80000000},
     {0x00000009, 0x00000000, 0x00000000, 0x80000000},
     {0x8141ab4b, 0x00000000, 0x00000000, 0x80000000}},
};
...
test_struct_di test_pack_fitd_fdti[] = {
    {{10000, 0x00000000, 0x00000000, 0x00000000}, 10000},
    {
        {INT_MAX, 0x00000000, 0x00000000, 0x00000000},
        INT_MAX,
    },
    {
        {(unsigned)INT_MAX + 1, 0x00000000, 0x00000000, 0x80000000},
        INT_MIN,
    },
...
START_TEST(test_fdti) {
    int result = 0;
    s21_from_decimal_to_int(test_pack_fitd_fdti[_i].op1, &result);
    ck_assert_int_eq(result, test_pack_fitd_fdti[_i].op2);
}
END_TEST

START_TEST(test_fitd) {
    s21_decimal result;
    s21_from_int_to_decimal(test_pack_fitd_fdti[_i].op2, &result);
    ck_assert_mem_eq(&result, &test_pack_fitd_fdti[_i].op1, sizeof(s21_decimal));
}
END_TEST
...
test_struct_ddd test_pack_floor[] = {
    {{0b00000000000000000000000000110010, 0b00000000000000000000000000000000,
    ...
    {{0b00000000000000000000000000100010, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b00000000000000010000000000000000},
    ...
    {{0b00000000000000000000000000000000, 0b00000000000000000000000000000000,
     ...
     {0b00000000000000000000000000000000, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b00000000000000000000000000000000}},
    {{0b00000001011100111100000111000111, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b10000000000001110000000000000000},
     {0b00000000000000000000000000000011, 0b00000000000000000000000000000000,
    ...
    {{0b00000000000000000000000000000000, 0b00000000000000000000000000000000,
     ...
     {0b00000000000000000000000000000000, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b10000000000000000000000000000000}},
    {{0b00000000000000000000000000101101, 0b00000000000000000000000000000000,
...
test_struct_ddd test_pack_truncate[] = {
    {{0b00000000000000000101001011110010, 0b00000000000000000000000000000000,
     ...
     {0b00000000000000000000000000000010, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b00000000000000000000000000000000}},
    {{0b00011011001111010100010001000001, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b00000000000001100000000000000000},
     {0b00000000000000000000000111001001, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b00000000000000000000000000000000}},
    {{0b00000000000000000000011111010000, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b00000000000000110000000000000000},
     {0b00000000000000000000000000000010, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b00000000000000000000000000000000}},
    {{0b00000000000000000000000000000000, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b10000000000110110000000000000000},
     {0b00000000000000000000000000000000, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b10000000000000000000000000000000}},
    {{0b00000000000000000000000000000011, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b10000000000000000000000000000000},
     {0b00000000000000000000000000000011, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b10000000000000000000000000000000}},
    {{0b00000000001000011110100010000100, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b00000000000001100000000000000000},
     {0b00000000000000000000000000000010, 0b00000000000000000000000000000000,
      0b00000000000000000000000000000000, 0b00000000000000000000000000000000}},
};
...
START_TEST(test_truncate) {
    s21_decimal result;
    s21_truncate(test_pack_truncate[_i].op1, &result);
    ck_assert_mem_eq(&result, &test_pack_truncate[_i].op2, sizeof(s21_decimal));
}
END_TEST

// s21_negate

test_struct_ddd test_pack_negate[] = {
...
START_TEST(test_negate) {
    s21_decimal result;
    s21_negate(test_pack_negate[_i].op1, &result);
    ck_assert_mem_eq(&result, &test_pack_negate[_i].op2, sizeof(s21_decimal));
}
END_TEST
...
int main() {
    ...
    // s21_from_decimal_to_int
    int test_pack_size_fitd_fdti = sizeof(test_pack_fitd_fdti) / sizeof(test_struct_di);
    tcase_add_loop_test(tc, test_fitd, 0, test_pack_size_fitd_fdti);
    tcase_add_loop_test(tc, test_fdti, 0, test_pack_size_fitd_fdti);
    ...
    // truncate
    test_pack_size = sizeof(test_pack_truncate) / sizeof(test_struct_ddd);
    tcase_add_loop_test(tc, test_truncate, 0, test_pack_size);

    // negate
    test_pack_size = sizeof(test_pack_negate) / sizeof(test_struct_ddd);
